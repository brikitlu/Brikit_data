...
from tasks.Bert.utils.data import DocumentDatasetForPredict
from tasks.Bert.network.model_architechure_bert_multi_scale import DocumentBertScoringModel
import yaml
from types import SimpleNamespace
