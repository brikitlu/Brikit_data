...
from tasks.clean.utils.filter_ import CleanerPipeline
from tasks.clean.utils.extractor import ExtractorPipeline
from tasks.clean.utils.initializer import ProcessorInitializer
from tasks.clean.utils.loggings import count_global, count_positive, err_callback
import re
import os
import logging
import json
...
class DataCleaner:
    ...
    text cleaner
    """
    def __init__(self, config_path="clean_config.yaml"):
