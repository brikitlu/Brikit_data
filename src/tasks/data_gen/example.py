...
openai.api_key = os.getenv("AZURE_OPENAI_KEY")  # os.getenv("AZURE_OPENAI_KEY")
openai.api_base = os.getenv("AZURE_OPENAI_ENDPOINT") # os.getenv("AZURE_OPENAI_ENDPOINT") # your endpoint should look like the following https://YOUR_RESOURCE_NAME.openai.azure.com/
openai.api_type = os.getenv("azure")
openai.api_version = 'gpt-3.5'  # this may change in the future
