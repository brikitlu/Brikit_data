...
# with open("text_dedup/config.yaml", "r") as config_file:
...
def add_io_args(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:  # pragma: no cover
    ...
    (parser.add_argument("--path", type=str,  help="`path` in load_dataset"),)
    ...
    (parser.add_argument("--output", type=str, help="Path to deduplicated dataset output"),)
